...
class CarControllerImpl implements CarController {
  ...
  addCar = (req: Request, res: Response, next: NextFunction): void => {
    this.dealershipService.addCarToDealership(req.body.dealership, req.body)
      .then(car => {
  ...
  getAllCars = (_req: Request, res: Response, next: NextFunction): void => {
  ...
  deleteCar = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    await this.carService.getCar(req.params.id)
      .then(async car => {
        await this.dealershipService.deleteCarFromDealership(car.dealership.toString(), req.params.id)
          .then(car => {
            res.json(car.toJSON())
          })
          .catch(async error => {
  ...
  addReview = (req: Request, res: Response, next: NextFunction): void => {
    this.carService.addReview(req.params.id, req.body)
      .then(car => {
        res.json(car.toJSON())
      }).catch(error => {
        next(error)
  ...
  updateReview = (req: Request, res: Response, next: NextFunction): void => {
    this.carService.updateReview(req.params.carId, req.params.reviewId, req.body)
      .then(car => {
        res.json(car.toJSON())
      }).catch(error => {
        next(error)
  ...
  deleteReview = (req: Request, res: Response, next: NextFunction): void => {
    this.carService.deleteReview(req.params.carId, req.params.reviewId)
      .then(car => {
        res.json(car.toJSON())
      }).catch(error => {
        next(error)
